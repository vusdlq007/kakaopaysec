...
public class AccountResponseDTO {
    ...
    public AccountResponseDTO(Integer resCode, String resMessage, Long categoryId, String storeId, LocalDateTime approvedAt, String accessType, String storeName, String barcode, Integer earnPoint) {
        this.resCode = resCode;
        this.resMessage = resMessage;
